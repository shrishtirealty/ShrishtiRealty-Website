...
const data = {
  ...
  '3d-visualization': { title:'3D Visualization & Virtual Experience Studio', subtitle:"See your space designed before it's built.", description:'Hyper-realistic visual experiences using cutting-edge technology. We bring designs to life before a single brick is laid, allowing you to walk through your future space and make informed decisions.', expertise:['Photorealistic 3D renderings','3D floor plans & elevations','VR walkthroughs & immersive tours','360-degree panoramic tours','Animated flythrough videos','AR previews & on-site overlays','Lighting, texture & material simulation','Real-time design revisions'], audiences:['Developers & builders','Interior designers','Architects & planners','Contractors','Marketing & sales teams','Homeowners'], quote:'Experience your future space today.', img:'https://images.unsplash.com/photo-1617802690992-15d93263d3a9?w=1920&q=80', sideImg:'https://images.unsplash.com/photo-1626379953822-baec19c3accd?w=800&q=80' },
  'smart-portable-cabins': { title:'Smart Portable Cabins & Prefabricated Structures', subtitle:'Move-in ready spaces — designed smart, built fast, delivered anywhere.', description:'Modular, prefabricated solutions built with high-grade steel, thermal insulation, fire-resistant materials, modern interiors, and eco-friendly construction practices for rapid deployment.', expertise:['Prefab homes & luxury villas','Portable guest houses','Portable penthouse & rooftop cabins','Site offices & modular workspaces','Coworking pods & security cabins','Portable creche facilities','Portable toilets & sanitation units','Custom structures for clinics, cafes, retail kiosks, classrooms & labs'], audiences:['Developers & builders','Corporates & enterprises','Construction firms','Educational institutions','Farm owners & resorts','Event organizers','Government projects','Startups & entrepreneurs','Homeowners'], quote:'Smart structures for a smarter future.', img:'https://images.unsplash.com/photo-1510627489930-0c1b0bfb6785?w=1920&q=80', sideImg:'https://images.unsplash.com/photo-1613977257365-aaae5a9817ff?w=800&q=80' },
}
